var scrollListener = function(e){
	let bottomOfWindow = (window.pageYOffset || document.documentElement.scrollTop || document.body.scrollTop || 0) + window.innerHeight >= (document.querySelector('body').offsetHeight - 400);
      if (bottomOfWindow) {
      	let blackList = [];
